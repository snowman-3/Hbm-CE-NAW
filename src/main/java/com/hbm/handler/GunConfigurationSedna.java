...
public class GunConfigurationSedna implements Cloneable {
    ...
    public SoundEvent firingSoundEmpty = null;
    ...
    public SoundEvent reloadSoundEmpty = null;
    ...
    //crosshair
    public RenderScreenOverlay.Crosshair crosshair;
