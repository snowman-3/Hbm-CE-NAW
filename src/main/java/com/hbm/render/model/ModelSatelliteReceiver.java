...
public class ModelSatelliteReceiver extends ModelBase {
    ...
    public void renderModel(float scaleFactor) {
        ...
        Shape4.render(scaleFactor);
        Shape5.render(scaleFactor);
        Shape6.render(scaleFactor);
        Shape7.render(scaleFactor);
        Shape8.render(scaleFactor);
        Shape9.render(scaleFactor);
    }
