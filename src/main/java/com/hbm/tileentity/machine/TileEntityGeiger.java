...
@AutoRegister
public class TileEntityGeiger extends TileEntity implements ITickable, IRORValueProvider, SimpleComponent, CompatHandler.OCComponent {
    ...
    public String[] getFunctionInfo() {
        return new String[]{PREFIX_VALUE + "rad",};
    }
    ...
    public String[] methods() {
        return new String[]{"getRads"};
    }

    @Optional.Method(modid = "opencomputers")
    public Object[] invoke(String method, Context context, Arguments args) throws Exception {
        if (method.equals("getRads")) {
