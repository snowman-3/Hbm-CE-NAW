...
public class ContainerMachinePrecAss extends ContainerBase {
    ...
    public ContainerMachinePrecAss(InventoryPlayer invPlayer, IItemHandler assembler) {
        ...
        if(slot != null && slot.getHasStack()) {
            ...
            if(index <= tile.getSlots() - 1) {
                ...
                if(slotOriginal.getItem() instanceof IBatteryItem || slotOriginal.getItem() == ModItems.battery_creative) {
                    ...
                    if(!InventoryUtil.mergeItemStack(this.inventorySlots, slotStack, 4, 22, false)) return ItemStack.EMPTY;
                }
            }
