...
public class SpawnCondition {
	...
	protected SpawnCondition(int weight, Predicate<Biome> predicate) {
		name = null;
		spawnWeight = weight;
		canSpawn = predicate;
	}
	...
	protected boolean isValid(Biome biome) {
	...
	public static class WorldCoordinate {
		...
		protected WorldCoordinate(World world, ChunkPos coords, Random rand) {
			this.world = world;
			this.coords = coords;
			this.rand = rand;
		}
