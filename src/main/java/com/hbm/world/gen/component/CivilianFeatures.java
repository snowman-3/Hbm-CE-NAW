...
public class CivilianFeatures {
	...
	public static void registerComponents() {
		MapGenStructureIO.registerStructureComponent(NTMHouse1.class, "NTMHouse1");
		MapGenStructureIO.registerStructureComponent(NTMHouse2.class, "NTMHouse2");
		MapGenStructureIO.registerStructureComponent(NTMLab1.class, "NTMLab1");
		MapGenStructureIO.registerStructureComponent(NTMLab2.class, "NTMLab2");
		MapGenStructureIO.registerStructureComponent(RuralHouse1.class, "NTMRuralHouse1");
	}
	...
	public static class NTMHouse1 extends Component {
		...
		public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
			 ...
			 * this.fillWithBlocks(world, box, minX, minY, minZ, maxX, maxY, maxZ, blockToPlace.getDefaultState(), blockToReplace.getDefaultState(), alwaysReplace);
			...
			this.setBlockState(world, Blocks.OAK_FENCE.getDefaultState(), 2, 1, 0, box);
			this.fillWithRandomizedBlocks(world, box, 3, 1, 0, 5, 1, 0, false, rand, RandomSandstone);
			this.setBlockState(world, Blocks.OAK_FENCE.getDefaultState(), 6, 1, 0, box);
			this.setBlockState(world, Blocks.OAK_FENCE.getDefaultState(), 7, 1, 0, box);
			...
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 0, 2, 1, box);
			...
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 9 - 2, 2, 6, box);
			this.fillWithRandomizedBlocks(world, box, 9, 0, 0, 9, 0, 6, false, rand, RandomSandstone); //Right Wall
			this.generateMaybeBox(world, box, rand, 0.65F, 9, 1, 1, 9, 1, 6 - 1, Blocks.SAND.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);

			this.fillWithRandomizedBlocks(world, box, 4, 0, 1, 4, 1, 3, false, rand, RandomSandstone);
			this.setBlockState(world, ModBlocks.reinforced_sand.getDefaultState(), 4, 0, 4, box);

			//Loot/Sand
			this.setBlockState(world, ModBlocks.crate_weapon.getDefaultState(), 1, 0, 1, box);
			...
			this.fillWithBlocks(world, box, 5, 0, 1, 6, 0, 1, ModBlocks.crate.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.setBlockState(world, Blocks.SAND.getDefaultState(), 7, 0, 1, box);
			if(rand.nextFloat() <= 0.25)
				 this.setBlockState(world, ModBlocks.crate_metal.getDefaultState(), 9 - 1, 0, 1, box);
			this.generateMaybeBox(world, box, rand, 0.25F, 1, 0, 2, 3, 0, 6 - 1, Blocks.SAND.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);
			this.generateMaybeBox(world, box, rand, 0.25F, 5, 0, 2, 9 - 1, 0, 6 - 1, Blocks.SAND.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);
	...
	public static class NTMHouse2 extends Component {
		...
		public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
			...
			this.setBlockState(world, Blocks.OAK_FENCE.getDefaultState(), 2, 2, 0, box);
			this.fillWithRandomizedBlocks(world, box, 3, 2, 0, 3, 2, 0, false, rand, RandomSandstone);
			this.setBlockState(world, Blocks.OAK_FENCE.getDefaultState(), 4, 2, 0, box);
			...
			this.fillWithBlocks(world, box, 2, 2, 9, 4, 2, 9, Blocks.OAK_FENCE.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.fillWithBlocks(world, box, 1, 0, 1, 5, 0, 9 - 1, Blocks.SANDSTONE.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Floor
			//this.fillWithRandomizedBlocks(world, box, 1, 5 - 1, 0, 5, 5 - 1, 9, false, rand, RandomSandstone); //Ceiling
			this.fillWithBlocks(world, box, 1, 5 - 1, 0, 5, 5 - 1, 9, Blocks.SANDSTONE.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 3, 5, 9 - 1, box);
			...
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 15 - 6, 2, 0, box);
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 15 - 3, 2, 0, box);
			...
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 15 - 6, 5 - 1, 2, box);
			...
			this.setBlockState(world, Blocks.OAK_FENCE.getDefaultState(), 15 - 6, 2, 4, box);
			this.fillWithRandomizedBlocks(world, box, 15 - 6, 2, 5, 15 - 6, 2, 5, false, rand, RandomSandstone);
			this.fillWithBlocks(world, box, 15 - 6, 2, 9 - 3, 15 - 6, 2, 9 - 2, Blocks.OAK_FENCE.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.setBlockState(world, Blocks.STONE_SLAB.getStateFromMeta(1), 15, 1, 9 - 1, box);

			this.fillWithBlocks(world, box, 15 - 5, 0, 1, 15 - 1, 0, 9 - 1, Blocks.SANDSTONE.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Floor

			//Loot & Decorations
			//House 1
			int eastMeta = this.getDecoMeta(4);
			this.setBlockState(world, ModBlocks.machine_boiler.getStateFromMeta(4), 1, 1, 1, box);
			this.fillWithBlocks(world, box, 1, 2, 1, 1, 3, 1, ModBlocks.deco_pipe_quad_rusted.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.setBlockState(world, ModBlocks.deco_pipe_rim_rusted.getDefaultState(), 1, 5, 1, box);
			this.setBlockState(world, ModBlocks.crate.getDefaultState(), 2, 1, 3, box);
			this.setBlockState(world, ModBlocks.crate_can.getDefaultState(), 1, 1, 9 - 4, box);
			if(!hasPlacedLoot[0]) {
				this.setBlockState(world,
						Blocks.CHEST.getDefaultState().withProperty(BlockHorizontal.FACING, getDirection(EnumFacing.SOUTH)),
						1, 1, 9 - 2, box);
				WeightedRandomChestContentFrom1710.generateChestContents(rand, ItemPool.getPool(ItemPoolsComponent.POOL_MACHINE_PARTS), world.getTileEntity(new BlockPos(this.getXWithOffset(1, 9 - 2),
						this.getYWithOffset(1), this.getZWithOffset(1, 9 - 2))), 10);
				this.hasPlacedLoot[0] = true;
			}
			this.fillWithBlocks(world, box, 4, 1, 9 - 1, 5, 1, 9 - 1, ModBlocks.crate.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.setBlockState(world, ModBlocks.steel_grate.getStateFromMeta(7), 5, 1, 5, box);
			this.setBlockState(world, ModBlocks.crate_weapon.getDefaultState(), 5, 2, 5, box);
			...
			if(!hasPlacedLoot[1]) {
				this.setBlockState(world,
						Blocks.CHEST.getDefaultState().withProperty(BlockHorizontal.FACING, getDirection(EnumFacing.SOUTH)),
						15 - 5, 1, 1, box);
				WeightedRandomChestContentFrom1710.generateChestContents(rand, ItemPool.getPool(ItemPoolsLegacy.POOL_ANTENNA), world.getTileEntity(new BlockPos(this.getXWithOffset(15 - 5, 1),
						this.getYWithOffset(1), this.getZWithOffset(15 - 5, 1))), 10);
				this.hasPlacedLoot[1] = true;
			}
			this.setBlockState(world, ModBlocks.bobblehead.getStateFromMeta(rand.nextInt(16)), 15 - 5, 1, 4, box);
			...
			this.generateMaybeBox(world, box, rand, 0.25F, 15 - 4, 1, 1, 15 - 1, 1, 9 - 1, Blocks.SAND.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);
	...
	public static class NTMLab1 extends Component {
		...
		public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
			...
			IBlockState s = this.getBlockStateFromPos(world, 2, 0, 7 - 1, box);
			if (s.getMaterial().isReplaceable() || s.getBlock() == Blocks.AIR) {
				placeFoundationUnderneath(world, Blocks.STONEBRICK, 0, 2, 7 - 1, 2, 7 - 1, -1, box);
				this.setBlockState(world, Blocks.STONE_BRICK_STAIRS.getStateFromMeta(getStairMeta(0)), 2, 0, 7 - 1, box);
			}
			...
			//Pillars
			this.fillWithBlocks(world, box, 0, 0, 0, 0, 3, 0, ModBlocks.concrete_pillar.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 9, 0, 0, 9, 3, 0, ModBlocks.concrete_pillar.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.fillWithBlocks(world, box, 0, 0, 7 - 2, 0, 3, 7 - 2, ModBlocks.concrete_pillar.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 3, 0, 7 - 2, 3, 3, 7 - 2, ModBlocks.concrete_pillar.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 3, 0, 7, 3, 3, 7, ModBlocks.concrete_pillar.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 9, 0, 7, 9, 3, 7, ModBlocks.concrete_pillar.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.setBlockState(world, ModBlocks.brick_concrete_broken.getDefaultState(), 3, 4, 7 - 2, box);
			...
			this.generateMaybeBox(world, box, rand, 0.75F, 5, 2, 7, 9 - 2, 3, 7, Blocks.GLASS_PANE.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);
			...
			this.setBlockState(world, ModBlocks.tile_lab_cracked.getDefaultState(), 3, 0, 7 - 1, box);

			this.fillWithBlocks(world, box, 1, 4 - 1, 1, 1, 4, 4, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Ceiling
			this.fillWithBlocks(world, box, 2, 4, 1, 9 - 1, 4, 4, ModBlocks.brick_light.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 4, 4, 7 - 2, 9 - 1, 4, 7 - 1, ModBlocks.brick_light.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			for(byte i = 0; i < 4; i++) {
				this.setBlockState(world, ModBlocks.plant_flower.getStateFromMeta(i), 1, 2, 1 + i, box);
			}

			EnumFacing baseDoorFacing = EnumFacing.WEST;
			EnumFacing mode = this.getCoordBaseMode();
			EnumFacing doorFacing = baseDoorFacing;

			if (mode != null) {
				switch (mode) {
					case SOUTH -> doorFacing = baseDoorFacing.getOpposite();
					case WEST -> doorFacing = baseDoorFacing.rotateY();
					case EAST -> doorFacing = baseDoorFacing.rotateYCCW();
					default -> {}
				}
			}

			BlockPos doorPos = new BlockPos(this.getXWithOffset(3, 7 - 1), this.getYWithOffset(1), this.getZWithOffset(3, 7 - 1));
			ItemDoor.placeDoor(world, doorPos, doorFacing, ModBlocks.door_office, true);
			...
			this.setBlockState(world, ModBlocks.machine_electric_furnace_off.getStateFromMeta(northDecoMeta), 5, 1, 1, box);
			this.setBlockState(world, ModBlocks.machine_microwave.getStateFromMeta(northDecoMeta), 5, 2, 1, box);
			this.setBlockState(world, ModBlocks.deco_titanium.getDefaultState(), 6, 1, 1, box);
			this.setBlockState(world, ModBlocks.machine_shredder.getDefaultState(), 9 - 2, 1, 1, box);
			this.setBlockState(world, ModBlocks.deco_titanium.getDefaultState(), 9 - 1, 1, 1, box);
			this.fillWithBlocks(world, box, 5, 1, 3, 9 - 1, 1, 3, ModBlocks.deco_titanium.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			if(!hasPlacedLoot[0]) {
				this.setBlockState(world, ModBlocks.deco_loot.getDefaultState(), 6, 2, 3, box);
				LootGenerator.lootMedicine(world, this.getXWithOffset(6, 3), this.getYWithOffset(2), this.getZWithOffset(6, 3));
				this.hasPlacedLoot[0] = true;
			}

			this.setBlockState(world, ModBlocks.crate_can.getDefaultState(), 9 - 1, 1, 7 - 2, box);
			if(!hasPlacedLoot[1]) {
	...
	public static class NTMLab2 extends Component {
		...
		public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
			...
			IBlockState s = this.getBlockStateFromPos(world, 12 - 3, 11 - 4, 7, box);
			if (s.getMaterial().isReplaceable() || s.getBlock() == Blocks.AIR) {
				placeFoundationUnderneath(world, Blocks.STONEBRICK, 0, 12 - 3, 7, 12 - 2, 7, 11 - 4, box);
				IBlockState stairs = Blocks.STONE_BRICK_STAIRS.getStateFromMeta(getStairMeta(2));
				this.fillWithBlocks(world, box, 12 - 3, 11 - 4, 7, 12 - 2, 11 - 4, 7, stairs, Blocks.AIR.getDefaultState(), false);
			}
			...
			this.fillWithBlocks(world, box, 1, 11 - 3, 8, 1, 11 - 1, 8, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithRandomizedBlocks(world, box, 2, 11 - 4, 8, 2, 11 - 1, 8, false, rand, RandomSuperConcrete);
			this.fillWithBlocks(world, box, 3, 11 - 3, 8, 3, 11 - 1, 8, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithRandomizedBlocks(world, box, 4, 11 - 4, 8, 4, 11 - 1, 8, false, rand, RandomSuperConcrete);
			this.fillWithBlocks(world, box, 5, 11 - 3, 8, 5, 11 - 1, 8, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.fillWithBlocks(world, box, 6, 11 - 1, 8 - 2, 7, 11 - 1, 8 - 2, ModBlocks.concrete_super_broken.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.fillWithBlocks(world, box, 12, 11 - 3, 8 - 3, 12, 11 - 1, 8 - 3, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithRandomizedBlocks(world, box, 12, 11 - 3, 4, 12, 11 - 1, 4, false, rand, RandomSuperConcrete);
			this.fillWithBlocks(world, box, 12, 11 - 3, 3, 12, 11 - 1, 3, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithRandomizedBlocks(world, box, 12, 11 - 3, 2, 12, 11 - 1, 2, false, rand, RandomSuperConcrete);
			this.fillWithBlocks(world, box, 12, 11 - 3, 1, 12, 11 - 1, 1, ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithRandomizedBlocks(world, box, 12, 11, 1, 12, 11, 8 - 3, false, rand, RandomSuperConcrete);

			this.fillWithBlocks(world, box, 1, 0, 1, 12 - 1, 3, 1, ModBlocks.reinforced_stone.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Back Wall
			this.fillWithBlocks(world, box, 1, 0, 2, 1, 3, 8 - 2, ModBlocks.reinforced_stone.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Left Wall
			this.fillWithBlocks(world, box, 1, 0, 8 - 1, 12 - 1, 3, 8 - 1, ModBlocks.reinforced_stone.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Front Wall
			this.fillWithBlocks(world, box, 12 - 1, 0, 2, 12 - 1, 3, 8 - 2, ModBlocks.reinforced_stone.getDefaultState(), Blocks.AIR.getDefaultState(), false); // Right Wall
			this.fillWithBlocks(world, box, 6, 0, 3, 6, 3, 8 - 2, ModBlocks.reinforced_stone.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Internal Wall
			...
			this.fillWithBlocks(world, box, 4, 11 - 4, 1, 7, 11 - 4, 1, ModBlocks.tile_lab_broken.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Center Floor (Pain)
			this.setBlockState(world, ModBlocks.tile_lab_broken.getDefaultState(), 4, 11 - 4, 2, box);
			this.fillWithBlocks(world, box, 4, 11 - 4, 3, 4, 11 - 4, 5, ModBlocks.tile_lab_cracked.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.setBlockState(world, ModBlocks.tile_lab_broken.getDefaultState(), 5, 11 - 4, 3, box);
			this.fillWithBlocks(world, box, 5, 11 - 4, 4, 5, 11 - 4, 5, ModBlocks.tile_lab_cracked.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.setBlockState(world, ModBlocks.tile_lab_broken.getDefaultState(), 6, 11 - 4, 4, box);
			this.setBlockState(world, ModBlocks.tile_lab_cracked.getDefaultState(), 6, 11 - 4, 5, box);
			this.fillWithBlocks(world, box, 7, 11 - 4, 2, 7, 11 - 4, 3, ModBlocks.tile_lab_broken.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 7, 11 - 4, 4, 7, 11 - 4, 5, ModBlocks.tile_lab_cracked.getDefaultState(), Blocks.AIR.getDefaultState(), false);

			this.fillWithBlocks(world, box, 1, 11, 1, 2, 11, 8 - 1, ModBlocks.brick_light.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Left Ceiling
			this.fillWithBlocks(world, box, 3, 11, 8 - 2, 4, 11, 8 - 1, ModBlocks.brick_light.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 12 - 3, 11, 1, 12 - 1, 11, 8 - 3, ModBlocks.brick_light.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Right Ceiling
			this.fillWithBlocks(world, box, 3, 11, 1, 8, 11, 1, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false); //Center Ceiling (Pain)
			this.fillWithBlocks(world, box, 3, 11, 2, 4, 11, 2, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 7, 11, 2, 8, 11, 2, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 3, 11, 3, 3, 11, 5, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 4, 11, 4, 4, 11, 5, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 5, 11, 6, 5, 11, 8 - 1, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithBlocks(world, box, 8, 11, 3, 8, 11, 5, ModBlocks.waste_planks.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			if (mode != null) {
				switch (mode) {
					case NORTH, SOUTH -> doorFacing = baseDoorFacing.getOpposite();
					case WEST -> doorFacing = baseDoorFacing.rotateY();
					case EAST -> doorFacing = baseDoorFacing.rotateYCCW();
					default -> {
					}
			...
			BlockPos p1 = new BlockPos(this.getXWithOffset(12 - 3, 8 - 2), this.getYWithOffset(11 - 3), this.getZWithOffset(12 - 3, 8 - 2));
			BlockPos p2 = new BlockPos(this.getXWithOffset(12 - 2, 8 - 2), this.getYWithOffset(11 - 3), this.getZWithOffset(12 - 2, 8 - 2));

			ItemDoor.placeDoor(world, p1, doorFacing, ModBlocks.door_office, true);
			ItemDoor.placeDoor(world, p2, doorFacing, ModBlocks.door_office, true);

			this.fillWithBlocks(world, box, 1, 11 - 3, 8, 1, 11 - 1, 8,
					ModBlocks.reinforced_glass.getDefaultState(), Blocks.AIR.getDefaultState(), false);

			this.fillWithBlocks(world, box, 1, 11 - 3, 1, 1, 11 - 1, 1, ModBlocks.deco_steel.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			this.fillWithMetadataBlocks(world, box, 1, 11 - 3, 2, 1, 11 - 2, 3, ModBlocks.steel_grate, 7, Blocks.AIR, 0, false);
			this.setBlockState(world, ModBlocks.tape_recorder.getStateFromMeta(westMeta), 1, 11 - 1, 2, box);
			this.setBlockState(world, ModBlocks.steel_beam.getDefaultState(), 1, 11 - 1, 3, box);
			this.fillWithBlocks(world, box, 1, 11 - 3, 6, 1, 11 - 1, 6, ModBlocks.deco_pipe_framed_rusted.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.fillWithBlocks(world, box, 12 - 3, 11 - 3, 1, 12 - 2, 11 - 3, 1, ModBlocks.deco_steel.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.setBlockState(world, ModBlocks.vitrified_barrel.getDefaultState(), 2, 2, 2, box);
			...
			this.setBlockState(world, ModBlocks.crate.getDefaultState(), 4, 1, 8 - 2, box);
			this.setBlockState(world, ModBlocks.crate_lead.getDefaultState(), 4, 2, 8 - 2, box);
			if(!hasPlacedLoot[0]) {
			...
			this.fillWithBlocks(world, box, 4, 1, 8 - 3, 5, 1, 8 - 3, ModBlocks.crate_lead.getDefaultState(), Blocks.AIR.getDefaultState(), false);

			this.fillWithBlocks(world, box, 12 - 5, 1, 8 - 2, 12 - 5, 3, 8 - 2, ModBlocks.deco_steel.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			...
			this.setBlockState(world, ModBlocks.steel_beam.getDefaultState(), 12 - 2, 2, 8 - 2, box);
			this.fillWithBlocks(world, box, 12 - 4, 3, 8 - 2, 12 - 2, 3, 8 - 2, ModBlocks.steel_roof.getDefaultState(), Blocks.AIR.getDefaultState(), false);
			if(!hasPlacedLoot[1]) {
	...
	public static class RuralHouse1 extends Component {
		...
		public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
			...
			setBlockState(world, ModBlocks.concrete_colored_ext.getDefaultState(), 12, 0, 2, box);
			...
			setBlockState(world, ModBlocks.concrete_colored_ext.getDefaultState(), 8, 0, 10, box);
			...
			setBlockState(world, Blocks.BRICK_BLOCK.getDefaultState(), 3, 6, 4, box);
			setBlockState(world, Blocks.BRICK_BLOCK.getDefaultState(), 6, 6, 4, box);
			...
			setBlockState(world, Blocks.BRICK_BLOCK.getDefaultState(), 6, 6, 13, box);
			setBlockState(world, Blocks.BRICK_BLOCK.getDefaultState(), 3, 6, 13, box);
			...
			setBlockState(world, Blocks.BRICK_BLOCK.getDefaultState(), 1, 2, 9, box);
			...
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 11, 3, 2, box);
			...
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 8, 3, 11, box);
			...
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 1, 2, 12, box);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 1, 2, 10, box);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 1, 2, 8, box);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 1, 2, 5, box);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 4, 3, 9, box);
			//Wood Framing
			//North/Front
			...
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 1, 3, 3, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 3, 3, 1, box);
			...
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 4, 3, 0, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 9, 3, 0, box);
			...
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 14, 1, 2, box);
			fillWithMetadataBlocks(world, box, 14, 1, 4, 14, 1, 7, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 14, 1, 9, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 14, 3, 2, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 14, 3, 4, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 14, 3, 7, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 14, 3, 9, box);
			//South/Back
			fillWithMetadataBlocks(world, box, 9, 4, 10, 13, 4, 10, Blocks.LOG, logW);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 13, 3, 10, box);
			...
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 8, 1, 14, box);
			fillWithMetadataBlocks(world, box, 3, 1, 14, 6, 1, 14, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 1, 1, 14, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 8, 3, 14, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 1, 3, 14, box);
			//West/Right
			...
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 0, 3, 13, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 0, 3, 10, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 0, 3, 8, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(9), 0, 3, 4, box);
			...
			//Floor
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 11, 0, 2, box);
			...
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 4, 0, 9, box);
			fillWithMetadataBlocks(world, box, 2, 0, 10, 7, 0, 12, Blocks.PLANKS, 1);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 8, 0, 11, box);
			fillWithBlocks(world, box, 13, 1, 0, 14, 1, 0, Blocks.OAK_FENCE);
			//Porches
			...
			setBlockState(world, Blocks.PLANKS.getDefaultState(), 9, 0, 13, box);
			for(int i = 0; i < 3; i++) {
				fillWithMetadataBlocks(world, box, 10 + i, 0, 13 - i, 11 + i, 0, 13 - i, Blocks.PLANKS, 1);
				fillWithBlocks(world, box, 10 + i, 1, 13 - i, 11 + i, 1, 13 - i, Blocks.OAK_FENCE);
			}
			...
			//Roofing
			//Framing
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 1, 5, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 2, 6, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 3, 6, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 3, 7, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 4, 7, 3, box);
			fillWithMetadataBlocks(world, box, 4, 8, 3, 5, 8, 3, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 5, 7, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 6, 7, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 6, 6, 3, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 7, 6, 3, box);
			fillWithMetadataBlocks(world, box, 2, 5, 3, 3, 5, 3, Blocks.PLANKS, 1);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 3, 5, 2, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 3, 5, 1, box);
			fillWithMetadataBlocks(world, box, 3, 4, 0, 14, 4, 0, Blocks.SPRUCE_STAIRS, stairN);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 8, 5, 1, box);
			setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 9, 5, 1, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 10, 5, 1, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 9, 6, 1, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 10, 6, 1, box);
			fillWithMetadataBlocks(world, box, 10, 7, 1, 11, 7, 1, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 11, 6, 1, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 12, 6, 1, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 12, 5, 1, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 13, 5, 1, box);
			fillWithMetadataBlocks(world, box, 14, 4, 1, 14, 4, 10, Blocks.SPRUCE_STAIRS, stairE);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 13, 5, 10, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 12, 5, 10, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 12, 6, 10, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 11, 6, 10, box);
			fillWithMetadataBlocks(world, box, 10, 7, 10, 11, 7, 10, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 10, 6, 10, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 9, 6, 10, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 9, 5, 10, box);
			fillWithMetadataBlocks(world, box, 9, 4, 11, 9, 4, 14, Blocks.SPRUCE_STAIRS, stairE);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 8, 5, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 7, 5, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 7, 6, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 6, 6, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE), 6, 7, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 5, 7, 14, box);
			fillWithMetadataBlocks(world, box, 4, 8, 14, 5, 8, 14, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 4, 7, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 3, 7, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 3, 6, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 2, 6, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 2, 5, 14, box);
			setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW), 1, 5, 14, box);
			fillWithMetadataBlocks(world, box, 0, 4, 3, 0, 4, 14, Blocks.SPRUCE_STAIRS, stairW);
			//Beams
			for(int z = 6; z <= 11; z += 5) {
				for(int i = 0; i < 3; i++) {
					setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairE | 4), 2 + i, 5 + i, z, box);
					setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairW | 4), 7 - i, 5 + i, z, box);
				}
			}
			...
			setBlockState(world, Blocks.WOODEN_SLAB.getDefaultState(), 5, 8, 6, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getDefaultState(), 4, 8, 11, box);
			...
			//Doors
			placeDoor(world, box, Blocks.OAK_DOOR, 1, false, false, 11, 1, 2);
			placeDoor(world, box, Blocks.OAK_DOOR, 1, false, rand.nextBoolean(), 4, 1, 9);
			placeDoor(world, box, Blocks.OAK_DOOR, 2, false, rand.nextBoolean(), 8, 1, 11);
			//Windows
			...
			//Attic Access
			setBlockState(world, Blocks.TRAPDOOR.getStateFromMeta(getDecoModelMeta(4) >> 2), 6, 4, 10, box);
			fillWithMetadataBlocks(world, box, 6, 2, 10, 6, 3, 10, Blocks.LADDER, metaN);
			//Furniture
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairN | 4), 12, 1, 5, box); //tables
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(8), 12, 1, 6, box);
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairS | 4), 12, 1, 7, box);
			...
			setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(stairS | 4), 8, 1, 2, box); //couch
			setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(stairW), 7, 1, 2, box);
			setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(stairS), 6, 1, 2, box);
			fillWithMetadataBlocks(world, box, 5, 1, 2, 5, 1, 3, Blocks.DARK_OAK_STAIRS, stairE);
			setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(stairN), 5, 1, 4, box);
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairW), 10, 1, 5, box); //chairs
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairN), 8, 1, 6, box);
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairE), 9, 1, 8, box); //bookshelf
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairE | 4), 9, 2, 8, box);
			fillWithBlocks(world, box, 8, 1, 8, 8, 2, 8, Blocks.BOOKSHELF);
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairW), 7, 1, 8, box);
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairW | 4), 7, 2, 8, box);
			fillWithMetadataBlocks(world, box, 7, 3, 8, 9, 3, 8, Blocks.WOODEN_SLAB, 1);
			setBlockState(world, Blocks.DOUBLE_STONE_SLAB.getDefaultState(), 4, 1, 5, box); //kitchen
			setBlockState(world, rand.nextBoolean() ? ModBlocks.machine_electric_furnace_off.getStateFromMeta(metaN) : Blocks.FURNACE.getStateFromMeta(metaN), 3, 1, 5, box); //idk why the meta is off between all these blocks and idc
			fillWithBlocks(world, box, 2, 1, 5, 2, 1, 6, Blocks.DOUBLE_STONE_SLAB);
			setBlockState(world, Blocks.CAULDRON.getStateFromMeta(2), 2, 1, 7, box);
			setBlockState(world, Blocks.DOUBLE_STONE_SLAB.getDefaultState(), 2, 1, 8, box);
			setBlockState(world, Blocks.DOUBLE_STONE_SLAB.getDefaultState(), 4, 3, 5, box);
			setBlockState(world, Blocks.REDSTONE_LAMP.getDefaultState(), 3, 3, 5, box);
			setBlockState(world, Blocks.DOUBLE_STONE_SLAB.getDefaultState(), 2, 3, 5, box);
			setBlockState(world, ModBlocks.steel_wall.getStateFromMeta(metaN), 3, 3, 6, box);
			setBlockState(world, ModBlocks.radiorec.getStateFromMeta(getDecoMeta(2)), 8, 2, 2, box);
			setBlockState(world, Blocks.FLOWER_POT.getDefaultState(), 7, 2, 4, box);

			fillWithBlocks(world, box, 2, 1, 12, 3, 1, 12, Blocks.BOOKSHELF); //bookshelf/desk
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairE | 4), 4, 1, 12, box);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(8), 5, 1, 12, box);
			setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairW | 4), 6, 1, 12, box);
			fillWithBlocks(world, box, 7, 1, 12, 7, 2, 12, Blocks.BOOKSHELF);
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(5), 5, 1, 11, box); //seat
			placeBed(world, box, 1, 3, 1, 10);
			setBlockState(world, Blocks.FLOWER_POT.getDefaultState(), 4, 2, 12, box);
			setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(0)), 5, 2, 12, box);

			fillWithMetadataBlocks(world, box, 4, 5, 5, 5, 5, 5, Blocks.DARK_OAK_STAIRS, stairS | 4); //seat and desk
			setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(1), 4, 5, 6, box);
			setBlockState(world, ModBlocks.crate_can.getDefaultState(), 7, 5, 7, box); //conserve crates
			setBlockState(world, ModBlocks.crate_can.getDefaultState(), 2, 5, 9, box);
			setBlockState(world, ModBlocks.crate_can.getDefaultState(), 3, 5, 11, box);
			if(rand.nextBoolean())
				setBlockState(world, ModBlocks.machine_diesel.getStateFromMeta(metaE), 7, 5, 9, box);
			setBlockState(world, rand.nextBoolean() ? ModBlocks.crate_weapon.getDefaultState() : ModBlocks.crate.getDefaultState(), 6, 5, 12, box);
		...
		public static class BrokenStairs extends BlockSelector {
			...
			public void selectBlocks(Random rand, int posX, int posY, int posZ, boolean notInterior) {
				...
				if (chance < 0.7F) {
					this.blockstate = Blocks.OAK_STAIRS.getStateFromMeta(this.metadata);
				} else if (chance < 0.97F) {
					this.blockstate = Blocks.WOODEN_SLAB.getDefaultState();
				} else {
		...
		public static class BrokenBlocks extends BlockSelector {
			...
			public void selectBlocks(Random rand, int posX, int posY, int posZ, boolean notInterior) {
				...
				if (chance < 0.6F) {
					this.blockstate = Blocks.PLANKS.getDefaultState();
				} else if (chance < 0.8F) {
					this.blockstate = Blocks.OAK_STAIRS.getStateFromMeta(rand.nextInt(4));
				} else {
					this.blockstate = Blocks.WOODEN_SLAB.getDefaultState();
				}
			}
