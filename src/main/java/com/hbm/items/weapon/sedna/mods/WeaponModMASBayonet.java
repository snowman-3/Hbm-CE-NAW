...
public class WeaponModMASBayonet extends WeaponModBase {
	...
	public <T> T eval(T base, ItemStack gun, String key, Object parent) {
		if(Objects.equals(key, GunConfig.FUN_ANIMNATIONS)) return (T) LAMBDA_MAS36_ANIMS;
		...
		if(Objects.equals(key, GunConfig.CON_ORCHESTRA)) return (T) ORCHESTRA_MAS36;
	...
	@SuppressWarnings("incomplete-switch") public static BiFunction<ItemStack, GunAnimation, BusAnimationSedna> LAMBDA_MAS36_ANIMS = (stack, type) -> {
