...
public class ItemGunChemthrower extends ItemGunBaseNT implements IFillableItem {
    ...
    public ItemGunChemthrower(WeaponQuality quality, String s, GunConfig... cfg) {
        super(quality, s, cfg);
    }
    ...
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_FIRE = (stack, ctx) -> {
        ...
        EntityChemical chem = new EntityChemical(entity.world, entity, sideOffset, heightOffset, forwardOffset);
        chem.setFluid((FluidType) mag.getType(stack, ctx.inventory));
        entity.world.spawnEntity(chem);
